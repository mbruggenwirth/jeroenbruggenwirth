...
gulp.task( 'bower', require( './gulp_config/bower.task.js' ) );
...
gulp.task( 'html-include', require( './gulp_config/htmltaginclude.task.js' ) );
gulp.task( 'imagemin', require( './gulp_config/imagemin.task.js' ) );
